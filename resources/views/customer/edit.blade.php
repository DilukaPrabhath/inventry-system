            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Update customer details...</p>
                </div>
                <div class="card-body">
                  <form method="post" action="update/{{$customer->id}}">
                    {{csrf_field()}}
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="number" name="telephone" value="{{$customer->telephone}}" class="form-control">
                        </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="details" rows="5">{{$customer->details}}</textarea>
                          </div>
                        </div>
                      </div>
                    </div>
